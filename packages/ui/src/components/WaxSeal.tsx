 ...
 * night, wine for one already played. Ported from Calendar's WaxSeal (that
 * app can't import this package — separate deploy) so the platform header
 * and activity feed can use the exact same "play-day" icon.
 */
