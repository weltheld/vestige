 ...
 * module switcher with its three tabs (Calendar / Journal / Codex — labelled
 * on desktop, icon-sized below lg), then the campaign pill (desktop only)
 * and profile chip. Keep in sync with VestigeHeader when its layout changes.
 */
    ...
    <header className="border-b border-hairline bg-parchment">
      <div className="mx-auto flex h-16 max-w-[1440px] items-center gap-3 px-4 sm:px-8">
        ...
        {/* Segmented module switcher — same track chrome as the real one
            (see SEGMENT_TRACK in VestigeHeader), with three tab-shaped
