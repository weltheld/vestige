...
/**
 * The email-magic-link sign-in form. Split out of the login page so the page
 * itself can be a Server Component and short-circuit straight to the
 * destination for a visitor who's already signed in — this form only ever
 * renders for a genuinely signed-out visitor.
 */
