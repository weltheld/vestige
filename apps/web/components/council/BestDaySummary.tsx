import { longDateLabel, weekdayLabel } from "@/lib/calendar/calendar";
...
export function BestDaySummary({
  ...
  if (!bestDayIso) {
    return (
      <div className="rounded-card border border-hairline bg-surface p-3 text-center text-xs text-ink-soft">
  ...
  return (
    <div className="rounded-card border border-[color-mix(in_srgb,var(--dm-gold)_40%,var(--surface))] bg-[color-mix(in_srgb,var(--dm-gold)_10%,var(--surface))] p-3">
