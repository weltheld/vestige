            ...
            >
              <span className="flex h-8 w-8 shrink-0 items-center justify-center">
                {item.variant === "playday" ? (
                  <WaxSeal played={false} size={30} />
                ) : (
                  <span className="flex h-8 w-8 items-center justify-center overflow-hidden rounded-full bg-parchment text-gold ring-1 ring-hairline">
                    {item.avatarUrl ? (
