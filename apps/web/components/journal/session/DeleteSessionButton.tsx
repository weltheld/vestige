  ...
  return (
    <>
      <button
        ...
        className="flex items-center gap-1.5 font-body text-[12px] text-wine underline decoration-[color-mix(in_srgb,var(--wine)_40%,transparent)] underline-offset-2 hover:decoration-wine"
      >
