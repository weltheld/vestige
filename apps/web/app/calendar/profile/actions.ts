...
export async function updateProfileAction(
  ...
  revalidatePath("/calendar/profile");
  // If they're already a member of a campaign, send them there; otherwise
  // the platform home. Fully-prefixed same-app paths — the consumer
  // router.pushes them as-is.
  return { ok: true, nextHref: slug ? `/calendar/g/${slug}` : "/app" };
}
