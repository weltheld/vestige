...
export default async function SessionListPage({
  ...
  return (
    // Same shell as the Codex page — full page width, primary action on the
    // right, content sections below. No page headline: the module tab (in
    // the header above) already says "Journal", and the campaign name lives
    // in the platform header's campaign switcher, so neither is repeated here
    // (and the old image sidebar/banner is gone with it).
