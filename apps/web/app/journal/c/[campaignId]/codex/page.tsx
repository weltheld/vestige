      ...
      <div className="flex flex-wrap items-end justify-between gap-3">
        <div>
          ...
          <p className="mt-1 font-body text-[13px] text-ink-soft">
            The people your party has met — {npcs.length} {npcs.length === 1 ? "entry" : "entries"}.
          </p>
        </div>
        <Link
      ...
      {npcs.length === 0 ? (
        <div className="flex flex-col items-center gap-4 rounded-xl bg-cod-soft px-6 py-20 text-center">
          ...
          <p className="font-body text-[15px] text-ink-soft">
            No entries yet. Add an NPC here, or type @ while writing a session
            to record one in passing.
          </p>
        </div>
      ) : (
            ...
            return (
              ...
              >
                <div className="flex items-baseline justify-between gap-3">
                  ...
                  <NpcStatusLabel status={npc.status} />
                </div>
